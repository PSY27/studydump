...
// Show Error
const error = (tip, msg) => {
  if (isDebugAllowed()) console.log('\x1b[31m', 'Error :: ', tip, '\n', msg || '', '\n\r\x1b[0m');
};

// Show Success
const success = (tip, msg) => {
  if (isDebugAllowed()) console.log('\x1b[32m', 'Success :: ', tip, '\n', msg || '', '\n\r\x1b[0m');
};

// Show Warning
const warn = (tip, msg) => {
  if (isDebugAllowed()) console.log('\x1b[33m', 'Warning :: ', tip, '\n', msg || '', '\n\r\x1b[0m');
};

const debug = (tip, msg) => {
  if (isDebugAllowed()) console.log('\x1b[34m', 'Debug :: ', tip, '\n', msg || '', '\n\r\x1b[0m');
};

// Show Info Tip
const info = (tip, msg) => {
  if (isDebugAllowed()) console.log('\x1b[36m', 'Info :: ', tip, '\n', msg || '', '\n\r\x1b[0m');
};
